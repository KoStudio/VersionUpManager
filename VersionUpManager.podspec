...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of VersionUpManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kmk/VersionUpManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kmk' => '44663768@163.com' }
  s.source           = { :git => 'https://github.com/kmk/VersionUpManager.git', :tag => s.version.to_s }
